...
public abstract class AbstractShellNode extends AbstractAsyncShellNode implements ShellNode {
    ...
    protected AbstractShellNode(final ShellScene shellScene, final ListeningExecutorService shellExecutor) {
     ...
     * the node's state.
     *
     * @param execute True to execute the process by the this node's
