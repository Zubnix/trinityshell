...
// * <code>Display</code> that is wrapped by a <code>ManagedDisplay</code>.
// After
...
// * <p>
// * The <code>EventDispatcher</code> implements the main hyperdrive even loop
// in
// * it's run method. This method is activated by the
...
// private final Map<Object, List<EventBus>> eventRecipients = new
// WeakHashMap<Object, List<EventBus>>();
//
...
//
// @Inject
// ShellDisplayEventDispatcherImpl(@Named("ShellEventBus") final EventBus
// shellEventBus,
...
// final List<EventBus> eventBusses =
// this.eventRecipients.get(displayEvent.getDisplayEventTarget());
// if (eventBusses == null) {
// return;
// }
//
...
// if (!this.eventRecipients.containsKey(displayEventTarget) &&
// (displayEventTarget instanceof DisplaySurface)) {
// createClientShellSurface((DisplaySurface) displayEventTarget);
// }
// }
// }
//
// private void createClientShellSurface(final DisplaySurface
...
// final Object displayEventTarget) {
// synchronized (this.eventRecipients) {
// final List<EventBus> nodeEventBusses =
// this.eventRecipients.get(displayEventTarget);
// if (nodeEventBusses != null) {
