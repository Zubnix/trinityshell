...
public abstract class SubViewBindingMeta extends ViewBindingMeta {
    ...
    ViewBindingMeta scan() {
        ...
        this.observableCollection = ViewBindingMetaUtil.scanFieldObservableCollection(getSubViewField())
                                                       .or(ViewBindingMetaUtil.scanClassObservableCollection(subviewClass));
        this.dataModelContext = ViewBindingMetaUtil.scanFieldDataModelContext(getSubViewField())
                                                   .or(ViewBindingMetaUtil.scanClassDataModelContext(subviewClass));
        this.eventSignals = ViewBindingMetaUtil.scanFieldEventSignals(getSubViewField())
                                               .or(ViewBindingMetaUtil.scanClassEventSignals(subviewClass));
        this.propertySlots = ViewBindingMetaUtil.scanFieldPropertySlots(getSubViewField())
                                                .or(ViewBindingMetaUtil.scanClassPropertySlots(subviewClass));
