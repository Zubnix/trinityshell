...
@NotThreadSafe
@AutoFactory
public class XSimpleShellSurface extends EventBus implements ShellSurface, ShellSurfaceConfigurable {
    ...
    XSimpleShellSurface(@Nonnull final Buffer buffer) {
    ...
    public ShellSurfaceConfigurable markDamaged(@Nonnull final RectangleImmutable damage) {
        this.pendingDamage = Optional.of(this.damage.orElse(damage)
                                                    .union(damage));
        return this;
    }
