...
// final Optional<DisplayEvent> optionalFocusGainNotifyEvent =
// Optional.of(focusGainNotifyEvent);
// final DisplayEvent buttonNotifyEvent = new ButtonNotify(null);
// final Optional<DisplayEvent> optionalButtonNotifyEvent =
// Optional.of(buttonNotifyEvent);
//
...
//
// final RenderEventConverter qjRenderEventConverter =
// mock(RenderEventConverter.class);
...
//
// new ViewEventTracker( qjRenderEventConverter,
// eventTarget,
// view);
//
