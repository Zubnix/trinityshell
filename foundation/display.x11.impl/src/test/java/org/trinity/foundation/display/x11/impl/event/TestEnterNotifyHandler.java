...
public class TestEnterNotifyHandler {
	...
	public void testEventHandling() {
		...
		final Optional<PointerEnterNotify> pointerEnterNotifyOptional = this.enterNotifyHandler.handle(this.xcb_generic_event);
	...
	public void testGetTarget() {
		...
		when(this.xWindowPool.get((DisplaySurfaceHandle) any())).thenAnswer(new Answer<Object>() {
			...
			public Object answer(final InvocationOnMock invocation) throws Throwable {
				...
				if(xWindowHandle != null && xWindowHandle.getNativeHandle().equals(TestEnterNotifyHandler.this.targetWindowId)) {
		...
		final Optional<DisplaySurface> target = this.enterNotifyHandler.getTarget(this.xcb_generic_event);
