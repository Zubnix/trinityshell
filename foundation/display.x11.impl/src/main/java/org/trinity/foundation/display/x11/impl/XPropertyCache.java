...
//
// private final Map<DisplaySurface, Map<String, Map<String, Object>>>
// nativeProtocolsValuesCache = new HashMap<DisplaySurface, Map<String,
// Map<String, Object>>>();
// private final Map<DisplaySurface, Set<String>> nativeProtocolValidityCache =
// new HashMap<DisplaySurface, Set<String>>();
//
...
// }
//
// private Set<String> getAllInvalidNativeProtocols(final DisplaySurface
// displaySurface) {
// Set<String> changedNativeProtocols =
// this.nativeProtocolValidityCache.get(displaySurface);
...
// }
//
// private Map<String, Object> queryNativeProperty(final DisplaySurface
// displaySurface,
// final String nativeProperty) {
// // TODO rewrite this method. Move lookup logic to separate classes.
//
// final int windowId = ((XWindowHandle)
// displaySurface.getDisplaySurfaceHandle()).getNativeHandle().intValue();
//
// final Map<String, Object> valueMap = new HashMap<String, Object>();
//
// if (nativeProperty.equals("WM_NAME")) {
//
// final xcb_get_property_cookie_t cookie_t =
// LibXcb.xcb_icccm_get_wm_name(this.xConnection
// .getConnectionReference(),
// windowId);
//
// final xcb_generic_error_t e = new xcb_generic_error_t();
// final xcb_icccm_get_text_property_reply_t prop = new
// xcb_icccm_get_text_property_reply_t();
// final int success = LibXcb.xcb_icccm_get_wm_name_reply(
...
// wmProtocolsAtomId);
//
// final xcb_icccm_get_wm_protocols_reply_t protocols = new
// xcb_icccm_get_wm_protocols_reply_t();
// final xcb_generic_error_t e = new xcb_generic_error_t();
//
// final int success =
// LibXcb.xcb_icccm_get_wm_protocols_reply(this.xConnection.getConnectionReference(),
// cookie,
// protocols,
// e);
//
...
//
// final Map<String, Map<String, Object>> allProperties =
// getAllProperties(displaySurface);
...
// }
//
// final Set<String> changedNativeProtocols =
// this.nativeProtocolValidityCache.get(displaySurface);
//
// if (changedNativeProtocols.remove(xProperty)) {
// final Map<String, Object> nativePropertyVaue = queryNativeProperty(
// displaySurface,
// xProperty);
...
// }
//
// private Map<String, Map<String, Object>> getAllProperties(final
// DisplaySurface displaySurface) {
// Map<String, Map<String, Object>> allValues =
// this.nativeProtocolsValuesCache.get(displaySurface);
// if (allValues == null) {
