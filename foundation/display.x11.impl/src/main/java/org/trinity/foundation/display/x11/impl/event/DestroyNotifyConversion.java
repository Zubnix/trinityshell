...
public class DestroyNotifyConversion implements XEventConversion {
	...
	public DisplayEvent convert(final xcb_generic_event_t event_t) {
		...
		final xcb_destroy_notify_event_t destroy_notify_event_t = new xcb_destroy_notify_event_t(
				xcb_generic_event_t.getCPtr(event_t), true);

		// TODO logging
		System.err.println(String.format("Received %s", destroy_notify_event_t
