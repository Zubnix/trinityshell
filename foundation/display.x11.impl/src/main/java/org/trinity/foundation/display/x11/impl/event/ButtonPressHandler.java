...
@Immutable
public class ButtonPressHandler implements XEventHandler {

	private static final Logger LOG = LoggerFactory.getLogger(ButtonPressHandler.class);
	private static final Integer EVENT_CODE = XCB_BUTTON_PRESS;
	private final XWindowCacheImpl windowCache;
	private final EventBus xEventBus;

	@Inject
	ButtonPressHandler(	final XWindowCacheImpl windowCache,
