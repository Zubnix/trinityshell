...
public class PropertyBindingTest {
	...
	public void testBindResolvableDataModelContext() throws NoSuchMethodException {
		...
		when(this.viewBindingMeta.appendDataModelPropertyChain((LinkedList<DataModelProperty>) any(),
															   eq(this.propertySlotDataContext))).thenAnswer(new Answer<Object>() {
			@Override
			public Object answer(final InvocationOnMock invocation) throws Throwable {
				final Object[] args = invocation.getArguments();
				final LinkedList<DataModelProperty> arg0 = (LinkedList<DataModelProperty>) args[0];
				arg0.add(new RootDataModelProperty(PropertyBindingTest.this.fooValue));
				arg0.add(new RootDataModelProperty(PropertyBindingTest.this.barValue));
				return TRUE;
			}
		});
		...
		final Method viewMethod = this.viewModel.getClass().getMethod("qux",
	...
	public void testBindUnresolvableDataModelContext() throws NoSuchMethodException {
		...
		verify(this.propertySlotInvocationDelegate,never()).invoke(eq(this.viewModel),
														   eq(viewMethod),
														   aryEq(new Object[]{this.arg0Val,
																			  this.arg1Val}));
	}
