...
import org.hypercube.view.fusionqtjambi.visual.DragButtonVisual;
 ...
 * @since 1.0
 */
public class DragButtonViewImpl extends QFusionViewImpl  implements ButtonView{

	@Override
	protected QWidget initVisual(QWidget parentVisual,
	                             Paintable paintable,
	                             Object... args) {
		return new DragButtonVisual(parentVisual);
	}
