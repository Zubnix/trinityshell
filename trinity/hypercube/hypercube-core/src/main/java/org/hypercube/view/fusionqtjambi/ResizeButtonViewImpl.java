...
import org.hypercube.view.fusionqtjambi.visual.ResizeButtonVisual;
 ...
 * @since 1.0
 */
public class ResizeButtonViewImpl extends QFusionViewImpl implements ButtonView {

	@Override
	protected QWidget initVisual(QWidget parentVisual, Paintable paintable,
			Object... args) {
		return new ResizeButtonVisual(parentVisual);
	}
