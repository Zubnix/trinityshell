 ...
 * @since 1.0
 */
public class ResizeButtonVisual extends QLabel implements StyledVisual {

	public static final String NAME = "ResizeButton";

	/**
	 * 
	 * @param parentVisual
	 */
	public ResizeButtonVisual(final QWidget parentVisual) {
		super(parentVisual);
	...
	public String getStyleName() {
		return ResizeButtonVisual.NAME;
	}
}
