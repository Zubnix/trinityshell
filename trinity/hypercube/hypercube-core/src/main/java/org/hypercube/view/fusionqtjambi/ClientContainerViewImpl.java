...
import org.hypercube.view.fusionqtjambi.visual.ClientContainerVisual;
 ...
 * @since 1.0
 */
public class ClientContainerViewImpl extends QFusionViewImpl {

	@Override
	protected QWidget initVisual(final QWidget parentVisual,
			final Paintable paintable, final Object... args) {
		return new ClientContainerVisual(parentVisual);
	}
}
