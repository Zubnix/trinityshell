...
import org.hypercube.view.fusionqtjambi.visual.VirtualRootVisual;
 ...
 * @since 1.0
 */
public class VirtRootViewImpl extends QFusionViewImpl {
	@Override
	protected QWidget initVisual(QWidget parentVisual,
	                             Paintable paintable,
	                             Object... args) {
		return new VirtualRootVisual(parentVisual);
	}
}
