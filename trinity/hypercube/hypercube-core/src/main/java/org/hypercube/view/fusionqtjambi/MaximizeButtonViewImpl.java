...
import org.hypercube.view.fusionqtjambi.visual.MaximizeButtonVisual;
 ...
 * @since 1.0
 */
public class MaximizeButtonViewImpl extends QFusionViewImpl implements
		ButtonView {

	@Override
	protected QWidget initVisual(final QWidget parentVisual,
			final Paintable paintable, final Object... args) {
		return new MaximizeButtonVisual(parentVisual);
	}
