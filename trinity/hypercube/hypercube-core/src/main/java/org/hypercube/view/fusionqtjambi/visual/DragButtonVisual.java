 ...
 * @since 1.0
 */
public class DragButtonVisual extends QLabel implements StyledVisual {

	private final static String NAME = "DragButton";

	/**
	 * 
	 * @param parentVisual
	 */
	public DragButtonVisual(final QWidget parentVisual) {
		super(parentVisual);
