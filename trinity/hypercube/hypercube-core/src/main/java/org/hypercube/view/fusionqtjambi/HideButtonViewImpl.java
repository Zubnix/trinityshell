...
import org.hypercube.view.fusionqtjambi.visual.HideButtonVisual;
 ...
 * @since 1.0
 */
public class HideButtonViewImpl extends QFusionViewImpl implements ButtonView {
	@Override
	protected HideButtonVisual initVisual(final QWidget parentVisual,
			final Paintable paintable, final Object... args) {
		return new HideButtonVisual(parentVisual);
	}

	@Override
	public PaintCall<?, ?> mouseButtonPressed(final MouseInput input) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public PaintCall<?, ?> mouseButtonReleased(final MouseInput input) {
		// TODO Auto-generated method stub
		return null;
	}
}
