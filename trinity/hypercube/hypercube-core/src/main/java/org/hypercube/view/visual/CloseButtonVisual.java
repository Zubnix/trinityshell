 ...
 * @since 1.0
 */
public class CloseButtonVisual extends QLabel implements StyledVisual {

	public static final String NAME = "CloseButton";

	/**
	 * 
	 * @param parentVisual
	 */
	public CloseButtonVisual(final QWidget parentVisual) {
		super(parentVisual);
