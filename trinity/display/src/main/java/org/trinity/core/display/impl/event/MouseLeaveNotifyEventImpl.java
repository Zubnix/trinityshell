 ...
 * @since 1.0
 */
public class MouseLeaveNotifyEventImpl extends DisplayEventImpl implements
	 ...
	 */
	@Inject
	protected MouseLeaveNotifyEventImpl(@Named("MouseLeave") final DisplayEventType displayEventType,
