 ...
 ****************************************/
public class ButtonPressedNotifyEventImpl extends ButtonNotifyEventImpl {
	 ...
	 ****************************************/
	@Inject
	protected ButtonPressedNotifyEventImpl(	@Named("ButtonPressed") DisplayEventType eventType,
