 ...
 * @since 1.0
 */
public class MapRequestEventImpl extends DisplayEventImpl implements
		MapRequestEvent {
	 ...
	 */
	@Inject
	protected MapRequestEventImpl(	@Named("MapRequest") final DisplayEventType displayEventType,
