 ...
 * @since 1.0
 */
public class UnmappedNotifyEventImpl extends DisplayEventImpl implements
		UnmappedNotifyEvent {
	 ...
	 */
	@Inject
	protected UnmappedNotifyEventImpl(	@Named("UnmapNotify") final DisplayEventType displayEventType,
