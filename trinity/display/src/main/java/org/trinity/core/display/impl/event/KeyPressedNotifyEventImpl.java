 ...
 ****************************************/
public class KeyPressedNotifyEventImpl extends KeyNotifyEventImpl {
	 ...
	 ****************************************/
	@Inject
	protected KeyPressedNotifyEventImpl(@Named("KeyPressed") final DisplayEventType eventType,
