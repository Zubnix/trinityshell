 ...
 * @since 1.0
 */
public class FocusGainNotifyEventImpl extends DisplayEventImpl implements
		FocusNotifyEvent {
	 ...
	 */
	@Inject
	protected FocusGainNotifyEventImpl(	@Named("FocusGainNotify") final DisplayEventType displayEventType,
