 ...
 * @since 1.0
 */
public class MouseEnterNotifyEventImpl extends DisplayEventImpl implements
	 ...
	 */
	@Inject
	protected MouseEnterNotifyEventImpl(@Named("MouseEnter") final DisplayEventType displayEventType,
