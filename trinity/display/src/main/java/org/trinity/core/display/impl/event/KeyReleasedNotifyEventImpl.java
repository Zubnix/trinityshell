 ...
 ****************************************/
public class KeyReleasedNotifyEventImpl extends KeyNotifyEventImpl {
	 ...
	 ****************************************/
	@Inject
	protected KeyReleasedNotifyEventImpl(	@Named("KeyReleased") final DisplayEventType eventType,
