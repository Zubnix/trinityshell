 ...
 * @since 1.0
 */
public class ConfigureRequestEventImpl extends DisplayEventImpl implements
	 ...
	 ****************************************/
	@Inject
	protected ConfigureRequestEventImpl(@Named("ConfigureRequest") final DisplayEventType configureNotify,
