 ...
 * @since 1.0
 */
public class StackingChangedNotifyEventImpl extends DisplayEventImpl implements
	 ...
	 */
	@Inject
	protected StackingChangedNotifyEventImpl(	@Named("StackingChanged") final DisplayEventType displayEventType,
