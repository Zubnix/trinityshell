...
import org.fusion.x11.core.XCoreAtoms;
...
public class XServerImpl implements XDisplayServer {
	...
	private final XCall<Integer, Long, Void> getInputFocus;
	...
	protected XServerImpl(	final Set<DisplayEventProducer> displayEventProducers,
							...
							@Named("getInputFocus") final XCall<Integer, Long, Void> getInputFocus,
