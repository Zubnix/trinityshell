...
import org.trinity.display.x11.impl.event.XDestroyWindowEventImpl;
...
public class XDestroyWindowEventConverter implements
	...
	public XDestroyWindowEventConverter(final XResourceFactory xResourceFactory,
	...
	public XEvent constructEvent(final NativeBufferHelper rawEvent) {
		...
		return new XDestroyWindowEventImpl(	this.eventCode.intValue(),
											sequence,
