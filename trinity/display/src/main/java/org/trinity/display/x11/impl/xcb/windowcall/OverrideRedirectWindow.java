 ...
 */
@Singleton
public class OverrideRedirectWindow extends AbstractXcbCall<Void, Long, Object> {
	@Override
	public boolean callImpl() {

		return Xcb4J
				.nativeOverrideRedirect(getConnectionReference().longValue(),
										((Integer) getArgs()[0]).intValue(),
