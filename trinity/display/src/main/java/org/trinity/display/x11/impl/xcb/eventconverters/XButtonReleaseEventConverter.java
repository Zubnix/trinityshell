...
public class XButtonReleaseEventConverter extends AbstractXButtonEventConverter {
	...
	private final PointerInputFactory mouseInputFactor;
	 ...
	 ****************************************/
	@Inject
	public XButtonReleaseEventConverter(final XResourceFactory xResourceFactory,
		...
		super(XProtocolConstants.BUTTON_RELEASE, xResourceFactory, display);
		this.displayEventFactory = displayEventFactory;
		this.buttonFactory = buttonFactory;
		this.inputModifiersFactory = inputModifiersFactory;
		this.mouseInputFactor = mouseInputFactory;
	}
	...
	public DisplayEvent convertEvent(final XEvent xEvent) {
		...
		final PointerInput input = this.mouseInputFactor
