 ...
 * @since 1.0
 */
public interface XKeySymbolRegistry {
	 ...
	 * @return
	 */
	Key[] getKeys(XKeySymbol keySymbol);
	 ...
	 * @return
	 */
	XcbKeySymbol getKeysymbol(long platformCode);
	 ...
	 * @return
	 */
	XcbKeySymbol getKeysymbol(String unicodeValue);
}
