...
// import org.trinity.display.x11.impl.displayprotocol.XCoreNative;
// import org.trinity.display.x11.impl.displayprotocol.XNativeCall;
// import
// org.trinity.display.x11.impl.displayprotocol.xcb.jni.NativeBufferHelper;
// import
// org.trinity.display.x11.impl.displayprotocol.xcb.windowcall.DestroyWindow;
// import
// org.trinity.display.x11.impl.displayprotocol.xcb.windowcall.GetChildWindows;
//
// /**
// * An <code>XcbCoreNativeCalls</code> statically groups all native calls that
// * are needed by the <code>XcbCoreInterfaceImpl</code> to talk to the X
// display
...
// @Override
// protected boolean nativeCallImpl() {
// return XCoreNative.nativeAddToSaveSet( getDisplayPeer()
// .longValue(),
// getArgs()[0].intValue(),
// getNativeBufferHelper()
// .getBuffer());
...
// protected boolean nativeCallImpl() {
// return XCoreNative
// .nativeSetSelectionOwner( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].longValue(),
// getArgs()[2].intValue(),
// getNativeBufferHelper()
...
// .nativePropagateEvent( getDisplayPeer(),
// getArgs()[0].intValue(),
// getArgs()[1].longValue(),
...
// public boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeFlush(getDisplayPeer(), getNativeBufferHelper()
// .getBuffer());
// return returnboolean;
// }
// }
...
// public boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeGetNextEvent(getDisplayPeer(),
// getNativeBufferHelper().getBuffer());
// return returnboolean;
// }
// }
...
// public boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeGetRootWindow( getDisplayPeer().longValue(),
// getNativeBufferHelper().getBuffer());
// return returnboolean;
// }
// }
...
// // length
// final long visualPeer = getNativeBufferHelper().readUnsignedInt();//
// xcb_visualid_t
// // visual
// getNativeBufferHelper().readUnsignedShort();// uint16_t
// // _class
...
// public boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeGiveFocus( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].intValue(),
// getNativeBufferHelper().getBuffer());
// return returnboolean;
...
// public boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeLower( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getNativeBufferHelper().getBuffer());
// return returnboolean;
// }
...
//
// final boolean returnboolean = XCoreNative
// .nativeMap( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getNativeBufferHelper().getBuffer());
//
// return returnboolean;
...
//
// final boolean returnboolean = XCoreNative
// .nativeMoveResize( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].intValue(),
// getArgs()[2].intValue(),
// getArgs()[3].intValue(),
...
//
// final boolean returnboolean = XCoreNative
// .nativeMove(getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].intValue(),
// getArgs()[2].intValue(),
// getNativeBufferHelper().getBuffer());
...
//
// final boolean returnboolean = XCoreNative
// .nativeOpenDisplay(getArgs()[0], getNativeBufferHelper()
// .getBuffer());
//
// return returnboolean;
// }
...
//
// final boolean returnboolean = XCoreNative
// .nativeOverrideRedirect(getDisplayPeer().longValue(),
...
//
// final boolean returnboolean = XCoreNative
// .nativeRaise( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getNativeBufferHelper().getBuffer());
//
// return returnboolean;
...
//
// final boolean returnboolean = XCoreNative
// .nativeReparent(getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].longValue(),
// getArgs()[2].intValue(),
// getArgs()[3].intValue(),
...
//
// final boolean returnboolean = XCoreNative
// .nativeResize( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].intValue(),
// getArgs()[2].intValue(),
// getNativeBufferHelper().getBuffer());
...
//
// final boolean returnboolean = XCoreNative
// .nativeSaveYourself(getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// true,
// getNativeBufferHelper().getBuffer());
//
...
//
// final boolean returnboolean = XCoreNative
// .nativeShutDown(getDisplayPeer().longValue(),
// getNativeBufferHelper().getBuffer());
//
// return returnboolean;
// }
...
//
// final boolean returnboolean = XCoreNative
// .nativeUnmap( getDisplayPeer().longValue(),
// getArgs()[0].longValue(),
// getNativeBufferHelper().getBuffer());
//
// return returnboolean;
...
// public boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeGetPointerInfo( getDisplayPeer().longValue(),
// getNativeBufferHelper().getBuffer());
// return returnboolean;
// }
// }
//
// /**
// * args: (Long) keySymsPeer, (Integer) keyCode, (Integer) keyColumn ret:
// * (Long) keySymbol
// */
...
// final boolean returnboolean = XCoreNative
// .nativeGetKeySymbol(keysymsPeer, keyCode, keyColumn, buffer);
// return returnboolean;
// }
// }
//
// /**
// * args: (Long) keySymsPeer, (Long) keySymbolCode ret: (Integer[]) keyCodes
// */
...
// final ByteBuffer buffer = getNativeBufferHelper().getBuffer();
// final boolean returnboolean = XCoreNative
// .nativeGetKeyCodes(keysymsPeer, keysymCode, buffer);
// return returnboolean;
// }
// }
//
// /**
// * args: (Long) windowId, (Integer) keyCode, (Integer) modifiersMask ret:
// * void
// */
...
//
// /**
// * args: (Long) windowId, (Integer) buttonCode, (Integer) modifiersMask ret:
// * void
// */
...
//
// final boolean returnboolean = XCoreNative
// .nativeUngrabButton(displayPeer,
// windowId,
// buttonCode,
// modifiersMask,
// buffer);
...
// * (Integer) dataFormat, (byte[]) data ret: void
// */
...
//
// /**
// * args:(String) xAtomName ret: (Long) atomId
// */
...
// protected boolean nativeCallImpl() {
// final boolean returnboolean = XCoreNative
// .nativeRegisterAtom(getDisplayPeer().longValue(),
// getArgs()[0],
// getNativeBufferHelper().getBuffer());
// return returnboolean;
// }
...
//
// /**
// * args: (Long) windowId, (Long) atomId, (Integer)format, (Byte[]) data ret:
// * void
// */
...
// protected boolean nativeCallImpl() {
// return XCoreNative
// .nativeSendClientMessage( getDisplayPeer().longValue(),
// ((Long) getArgs()[0])
// .longValue(),
// ((Long) getArgs()[1])
// .longValue(),
...
// @Override
// protected boolean nativeCallImpl() {
// return XCoreNative.nativeGrabKeyboard( getDisplayPeer()
// .longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].intValue(),
// getNativeBufferHelper()
...
// @Override
// protected boolean nativeCallImpl() {
// return XCoreNative.nativeUngrabMouse( getDisplayPeer()
// .longValue(),
// getArgs()[0].intValue(),
// getNativeBufferHelper()
// .getBuffer());
...
// @Override
// protected boolean nativeCallImpl() {
// return XCoreNative.nativeGetProperty( getDisplayPeer()
// .longValue(),
// getArgs()[0].longValue(),
// getArgs()[1].longValue(),
// getNativeBufferHelper()
...
// XNativeCall<Integer, Long, Void> {
// private GetInputFocus() {
// }
//
// @Override
// public Integer getResult() {
// final Integer windowId = Integer
// .valueOf((int) getNativeBufferHelper().readUnsignedInt());
// return windowId;
// }
//
// @Override
// protected boolean nativeCallImpl() {
// return XCoreNative.nativeGetInputFocus( getDisplayPeer()
// .longValue(),
// getNativeBufferHelper()
// .getBuffer());
// }
