...
public class XPropertyXAtomMultiText extends
	 ...
	 * @param atomId
	 */
	public XPropertyXAtomMultiText(final XServerImpl display,
	 ...
	 * 
	 */
	public XPropertyXAtomMultiText(final XServerImpl display, final String atomName) {
	...
	public void setPropertyInstance(
		...
		final FlexByteContainer rawDataContainer = new FlexByteContainer(
				totalSize);
