 ...
 */
@Singleton
public class XcbEventBridgeImpl implements XEventBridge<NativeBufferHelper> {
	...
	@Inject
	public XcbEventBridgeImpl(	final Set<XEventConverter<NativeBufferHelper>> parserHelpers,
