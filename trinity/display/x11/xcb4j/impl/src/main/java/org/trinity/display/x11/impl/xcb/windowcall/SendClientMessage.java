 ...
 */
@Bind
@Named("SendClientMessage")
@Singleton
public class SendClientMessage extends AbstractXcbCall<Void, Long, Object> {

	@Override
	protected boolean callImpl() {
		return Xcb4J.nativeSendClientMessage(	getConnectionReference()
														.longValue(),
												((Integer) getArgs()[0])
														.intValue(),
												((Integer) getArgs()[1])
