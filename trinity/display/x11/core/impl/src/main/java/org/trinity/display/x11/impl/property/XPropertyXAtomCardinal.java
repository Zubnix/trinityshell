...
public class XPropertyXAtomCardinal extends
		AbstractXProperty<XPropertyInstanceCardinal> {
	 ...
	 * 
	 */
	public XPropertyXAtomCardinal(final XServerImpl display, final String atomName) {
	 ...
	 * @param atomId
	 */
	public XPropertyXAtomCardinal(final XServerImpl display,
