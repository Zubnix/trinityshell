...
import org.trinity.display.x11.core.api.XResource;
...
public class XResourceImpl implements XResource {
	private final XResourceHandle xResourceHandle;

	/**
	 * @param xid
	 */
	protected XResourceImpl(final XResourceHandle xResourceHandle) {
