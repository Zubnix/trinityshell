...
public class XWindowImpl extends XResourceImpl implements XWindow {
	...
	private final XCall<PlatformRenderAreaAttributes, Long, Integer> getWindowAttributesCopy;
	...
	// public <T extends PropertyInstance> T getPropertyInstance(final
	// Property<T> property) {
	// T propertyReply;
	...
	// /**
	// * Set the cached value of the given property type, represented by the
	// given
	// * <code>XAtom</code>, as invalid. The cache will be valid again after it
	// is
	// * refreshed by a call to <code>getPropertyReply</code>.
	// * <p>
	// * A property can be invalidated by either a server generated
	// * <code>PropertyChangedNotifyEvent</code> which will call this method, or
	// a
	...
	// */
	// public void invalidateProperty(final AbstractXProperty<? extends
	...
	// /**
	// * Check if the cached value of the given property type, represented by
	// the
	...
	// */
	// private boolean isPropertyValid(final Property<? extends
	// PropertyInstance> property) {
	// boolean valid;
	...
	// @Override
	// public <T extends PropertyInstance> void setPropertyInstance( final
	// Property<T> property,
