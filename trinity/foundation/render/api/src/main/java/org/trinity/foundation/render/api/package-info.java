 ...
 * {@link org.trinity.foundation.render.api.Painter#initPaintPeer()}).</li>
 ...
 * should be placed on the event queue of the <code>Display</code> object. (See {@link org.trinity.foundation.display.api.DisplayEventProducer})</li>
