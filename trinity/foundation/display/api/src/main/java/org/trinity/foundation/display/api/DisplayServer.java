...
/**
 * A <code>DisplayServer</code> provides basic capabilities to talk to the
 * underlying native display functionality. One of the most fundamental aspects
 * of the <code>DisplayServer</code> is the queuing of {@link DisplayEvent}s.
 * <p>
