...
// * based on the text input it receives from the user. It filters a list of
// given
// * options based on the text that was inputted by the user. This filtered list
// * is presented to the user who can then navigate and selected a desired
// option.
// *
// * @author Erik De Rijcke
// * @since 1.0
// */
// public abstract class AbstractShellKeyDrivenMenu extends BaseShellWidget //
// implements
// // ShellKeyDrivenMenu
// {
//
...
// getFilteredChoices().get(AbstractShellKeyDrivenMenu.this.activeChoiceIdx);
...
// }
//
// public abstract List<String> getAllChoices();
//
// // @Override
// public void clear() {
// this.activeChoiceIdx = 0;
