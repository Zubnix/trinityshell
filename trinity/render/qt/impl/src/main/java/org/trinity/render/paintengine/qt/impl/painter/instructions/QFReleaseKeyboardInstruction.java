 ...
 ****************************************/
@Singleton
public class QFReleaseKeyboardInstruction implements QFPaintInstruction {

	/*****************************************
	 * 
	 ****************************************/
	protected QFReleaseKeyboardInstruction() {
	}
	...
	public void call(	final Paintable paintable,
		...
		renderEngine.getVisual(paintable).releaseKeyboard();
	}
}
