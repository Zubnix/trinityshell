 ...
 * @since 1.0
 */
public class PropertyInstancePlatformRenderArea extends BasePropertyInstance {

	private final PlatformRenderArea platformRenderArea;

	// public PropertyInstancePlatformRenderArea(final Display display,
	 ...
	 */
	@Inject
	protected PropertyInstancePlatformRenderArea(final Atom encodingType,
			final PlatformRenderArea platformRenderArea) {
		super(encodingType);
		this.platformRenderArea = platformRenderArea;
	}
