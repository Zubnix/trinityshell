 ...
 ****************************************/
public class BaseKeyPressedNotifyEvent extends BaseKeyNotifyEvent {
	 ...
	 ****************************************/
	@Inject
	protected BaseKeyPressedNotifyEvent(@Named("KeyPressed") final DisplayEventType eventType,
