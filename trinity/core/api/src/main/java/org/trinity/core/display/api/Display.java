 ...
 * <code>DisplayEvent</code>s happens when an {@link DisplayEventProducer} is added to
 ...
 * @see BaseDisplay
 */
public interface Display extends DisplayEventProducer {
	/**
	 ...
	 * 
	 * @param eventProducer
	 *            An {@link DisplayEventProducer} for this <code>Display</code>.
	 */
	void addEventProducer(DisplayEventProducer eventProducer);
