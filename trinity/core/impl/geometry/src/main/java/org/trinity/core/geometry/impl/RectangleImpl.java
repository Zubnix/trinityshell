...
public class RectangleImpl implements Rectangle {
	...
	@AssistedInject
	protected RectangleImpl(@Assisted("x") final int x,
	...
	@AssistedInject
	protected RectangleImpl(@Assisted final Rectangle rectangle) {
		this(	rectangle.getX(),
				rectangle.getY(),
				rectangle.getWidth(),
				rectangle.getHeight());
	...
	@AssistedInject
	protected RectangleImpl(@Assisted final Coordinates coordinates,
							@Assisted("width") final int width,
							@Assisted("height") final int height) {
