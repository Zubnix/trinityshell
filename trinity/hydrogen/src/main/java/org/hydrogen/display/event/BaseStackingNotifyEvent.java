...
import org.hydrogen.api.display.event.StackingNotifyEvent;
 ...
 * @since 1.0
 */
public class BaseStackingNotifyEvent extends BaseDisplayEvent implements
		StackingNotifyEvent {
	 ...
	 * @param eventSource
	 */
	public BaseStackingNotifyEvent(final DisplayEventSource eventSource) {
