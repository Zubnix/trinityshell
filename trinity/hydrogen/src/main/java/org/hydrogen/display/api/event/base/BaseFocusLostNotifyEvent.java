 ...
 * @since 1.0
 */
public class BaseFocusLostNotifyEvent extends BaseDisplayEvent implements
		FocusNotifyEvent {
	 ...
	 */
	@Inject
	protected BaseFocusLostNotifyEvent(	@Named("FocusLostNotify") final DisplayEventType displayEventType,
