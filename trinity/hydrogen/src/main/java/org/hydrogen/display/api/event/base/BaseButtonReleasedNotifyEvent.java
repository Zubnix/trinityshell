 ...
 ****************************************/
public class BaseButtonReleasedNotifyEvent extends BaseButtonNotifyEvent {
	 ...
	 ****************************************/
	@Inject
	protected BaseButtonReleasedNotifyEvent(@Named("ButtonReleased") DisplayEventType eventType,
											@Assisted DisplayEventSource eventSource,
											@Assisted MouseInput input) {
