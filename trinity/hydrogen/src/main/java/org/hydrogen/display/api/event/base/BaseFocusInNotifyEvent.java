 ...
 * 
 */
public class BaseFocusInNotifyEvent extends BaseDisplayEvent implements
		FocusNotifyEvent {
	 ...
	 */
	@Inject
	protected BaseFocusInNotifyEvent(final DisplayEventSource eventSource) {
		super(DisplayEventType.FOCUS_GAIN_NOTIFY, eventSource);
	}
}