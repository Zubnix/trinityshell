 ...
 * {@link org.hydrogen.api.paint.Painter#initPaintPeer()}).</li>
 ...
 * should be placed on the event queue of the <code>Display</code> object. (See {@link org.hydrogen.api.display.EventProducer})</li>
