 ...
 * {@link org.hydrogen.paint.api.Painter#initPaintPeer()}).</li>
 ...
 * should be placed on the event queue of the <code>Display</code> object. (See {@link org.hydrogen.display.api.EventProducer})</li>
