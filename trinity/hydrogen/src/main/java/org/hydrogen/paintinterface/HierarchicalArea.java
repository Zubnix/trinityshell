 ...
 * @since 1.0
 */
public interface HierarchicalArea extends Area {
	/**
	...
	/**
	 * The height of this <code>HierarchicalArea</code> is it's vertical size in
	 * the inverted Y-axis orthogonal space.
	 * 
	 * @return The height in pixels of this <code>HierarchicalArea</code>
	 * 
	 */
	int getHeight();

	/**
	 * The relative X value of this <code>HierarchicalArea</code>.
	 * <p>
	 * A relative value is the distance in pixels to the parent
	 * <code>HierarchicalArea</code> coordinate.
	 * 
	 * @return A relative X coordinate.
	 */
	int getRelativeX();

	/**
	 * The relative Y value of this <code>HierarchicalArea</code>.
	 * <p>
	 * A relative value is the distance in pixels to the parent
	 * <code>HierarchicalArea</code> coordinate.
	 * 
	 * @return A relative Y coordinate.
	 */
	int getRelativeY();

	/**
	 * The width of this <code>HierarchicalArea</code> is it's horizontal size
	 * in the inverted Y-axis orthogonal space.
	 * 
	 * @return The width of this <code>HierarchicalArea</code> in pixels.
	 * 
	 */
	int getWidth();
