 ...
 * 
 */
public class BaseClientManager extends BaseWidget {
	...
	public static class ClientManagerLabel extends ClientNameLabel {
		...
		protected void manageClient() {
			addEventHandler(this.eventHandler, DisplayEventType.BUTTON_PRESSED);
		}
	}
	 ...
	 * @param namePropertyName
	 */
	public BaseClientManager(final DesktopProtocol desktopProtocol) {
	 ...
	 * @return
	 */
	protected ClientManagerLabel newClientNameLabel(final RenderArea client) {
	 ...
	 * @param client
	 */
	public void manageClient(final RenderArea client) {
