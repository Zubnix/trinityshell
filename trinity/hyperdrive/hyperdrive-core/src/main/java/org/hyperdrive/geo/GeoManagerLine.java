...
public class GeoManagerLine extends GeoManagerWithChildren<LineProperty> {
	 ...
	 * depending if the <code>GeoManagerLine</code> layouts horizontal or
	 * vertical.
	 * <p>
	 * A child's weight is compared to other childeren's weight. This relative
	 * weight is then used to determine how much a child's height or width needs
	 * to be adjusted. For example: A child with weight 2 will be resized with a
	 * delta value of twice that of a child with a weight of 1 because 2 / 1 =
	 * 2.
	 * <p>
	 * When a weight of 0 or less is given, the child's dimension will be
	 * static.
	 * 
	 * @author Erik De Rijcke
	 * @since 1.0
