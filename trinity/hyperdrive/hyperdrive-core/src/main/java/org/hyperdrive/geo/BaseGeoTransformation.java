...
/**
 * A <code>GeoTransformation</code> represents a geometric transformation in
 * time. Current geometric property names end in 0, new ones in 1. A Delta value
 * is the subtraction of the new value with the current value so that:<br/>
 ...
 * @since 1.0
 */
public class BaseGeoTransformation implements GeoTransformation {
	...
	private final GeoTransformableRectangle parent0;
	private final GeoTransformableRectangle parent1;

	/**
	 * Create a new <code>GeoTransformation</code> with a number of current and
	 * new geometric values.
	 * 
	 * @param x0
	 ...
	 *            The new visibility.
	 */
	public BaseGeoTransformation(final int x0, final int y0, final int width0,
			final int height0, final boolean visible0,
			final GeoTransformableRectangle parent0, final int x1,
			final int y1, final int width1, final int height1,
			final boolean visible1, final GeoTransformableRectangle parent1) {
		this.x0 = x0;
		this.y0 = y0;
		this.width0 = width0;
	 ...
	 */
	@Override
	public GeoTransformableRectangle getParent0() {
		return this.parent0;
	}
	 ...
	 */
	@Override
	public GeoTransformableRectangle getParent1() {
		return this.parent1;
	}
}
