...
public interface GeoExecutor {
	 ...
	 * 
	 */
	void updatePlace(int relativeX, int relativeY);
	 ...
	 * 
	 */
	void updateSizePlace(int relativeX, int relativeY, int width, int height);
	 ...
	 * 
	 */
	void updateParent(GeoTransformableRectangle parent);
