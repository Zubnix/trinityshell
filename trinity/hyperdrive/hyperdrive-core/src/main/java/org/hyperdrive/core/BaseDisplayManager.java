...
import org.hyperdrive.api.core.DisplayManager;
 ...
 * @since 1.0
 */
public final class BaseDisplayManager implements DisplayManager {
	private static volatile BaseDisplayManager instance = new BaseDisplayManager();
	 ...
	 */
	public static synchronized BaseDisplayManager instance() {
		if (BaseDisplayManager.instance == null) {
			BaseDisplayManager.instance = new BaseDisplayManager();
		}
		return BaseDisplayManager.instance;
	}
