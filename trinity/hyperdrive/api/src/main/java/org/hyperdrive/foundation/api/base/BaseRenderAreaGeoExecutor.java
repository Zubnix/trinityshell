 ...
 * @see GeoExecutor
 */
public class BaseRenderAreaGeoExecutor extends AbstractGeoExecutor {
	 ...
	 * @param renderArea
	 */
	public BaseRenderAreaGeoExecutor(final RenderArea renderArea) {
	 ...
	 * type of {@link BaseRenderAreaGeoExecutor#getManipulatedArea()}, starting
