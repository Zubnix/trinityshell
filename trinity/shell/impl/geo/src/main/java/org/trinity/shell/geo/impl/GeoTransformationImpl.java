 ...
 * @since 1.0
 */
public class GeoTransformationImpl implements GeoTransformation {
	 ...
	 *            The new visibility.
	 */
	protected GeoTransformationImpl(final int x0,
									final int y0,
									final int width0,
									final int height0,
									final boolean visible0,
									final GeoTransformableRectangle parent0,
									final int x1,
									final int y1,
									final int width1,
									final int height1,
									final boolean visible1,
									final GeoTransformableRectangle parent1) {
		this.x0 = x0;
		this.y0 = y0;
		this.width0 = width0;
