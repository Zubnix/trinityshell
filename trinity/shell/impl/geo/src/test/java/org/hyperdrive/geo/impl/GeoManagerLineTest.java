...
import org.hyperdrive.geo.impl.GeoManagerLine;
import org.hyperdrive.geo.impl.LineProperty;
...
public class GeoManagerLineTest {
	...
	public void horizontalResizeParentTest() {
		...
		geoManagerLine.addManagedChild(this.child1, new LineProperty(10,
				new Margins(10, 10)));
		geoManagerLine.addManagedChild(this.child2, new LineProperty(30,
				new Margins(5)));
