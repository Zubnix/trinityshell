...
final class ClientWindow extends AbstractRenderArea {
	...
	ClientWindow(final ManagedDisplay managedDisplay,
			final PlatformRenderArea platformRenderArea, GeoExecutor geoExecutor) {
		setManagedDisplay(managedDisplay);
		setPlatformRenderArea(platformRenderArea);

		this.renderAreaGeoExecutor = new BaseRenderAreaGeoExecutor(this);
	...
	@Override
	public BaseRenderAreaGeoExecutor getGeoExecutor() {
