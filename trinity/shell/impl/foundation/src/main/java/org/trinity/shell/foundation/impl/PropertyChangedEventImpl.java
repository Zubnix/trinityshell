...
import org.trinity.shell.foundation.api.event.PropertyType;
 ...
 * @since 1.0
 */
final class PropertyChangedEventImpl<T extends Property<? extends PropertyInstance>>
	 ...
	 */
	PropertyChangedEventImpl(	final RenderArea renderArea,
								final boolean propertyDeleted,
								final T changedProperty) {
