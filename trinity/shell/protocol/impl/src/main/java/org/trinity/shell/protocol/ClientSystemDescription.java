 ...
 * @since 1.0
 */
public class ClientSystemDescription implements ProtocolEvent {
	...
	public ClientSystemDescription(final String systemdescription,
	...
	public ProtocolEventType getType() {
		return ClientSystemDescription.TYPE;
	}
}
