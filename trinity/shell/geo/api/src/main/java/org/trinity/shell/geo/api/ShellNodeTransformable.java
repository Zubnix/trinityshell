...
/**
 * A <code>ShellNodeTransformable</code> can have it's geometry changed over time.
 * <p>
 * To access the desired transformation of a <code>ShellNodeTransformable</code>,
 * implementing classes must provide a <code>ShellNodeTransformation</code> describing
 * the current and new geometric values of the <code>ShellNodeTransformable</code>.
 * 
...
public interface ShellNodeTransformable {
	/**
	 * The <code>ShellNodeTransformation</code> of this <code>ShellNodeTransformable</code>
