...
/**
 * A <code>ShellGeoTransformation</code> represents a geometric transformation in
 ...
 * @since 1.0
 */
public class ShellGeoTransformationImpl implements ShellGeoTransformation {
	...
	/**
	 * Create a new <code>ShellGeoTransformation</code> with a number of current and
	 ...
	 *            The new visibility.
	 */
	protected ShellGeoTransformationImpl(final int x0,
									final int y0,
									final int width0,
									final int height0,
