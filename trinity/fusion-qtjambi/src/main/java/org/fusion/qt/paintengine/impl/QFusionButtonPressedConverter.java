 ...
 * @since 1.0
 */
public final class QFusionButtonPressedConverter implements
	...
	@Inject
	protected QFusionButtonPressedConverter(@Named("QButtonPress") final QEvent.Type qType,
	...
	public ButtonNotifyEvent sinkEvent(	final DisplayEventSource source,
		...
		final MouseInput mouseInput = new BaseMouseInput(	Momentum.STARTED,
															button,
															inputModifiers,
															rootX,
															rootY,
