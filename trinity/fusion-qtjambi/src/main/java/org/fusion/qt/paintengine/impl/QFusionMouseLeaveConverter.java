 ...
 * @since 1.0
 */
public final class QFusionMouseLeaveConverter implements
	...
	@Inject
	protected QFusionMouseLeaveConverter(	@Named("QLeave") final QEvent.Type qType,
	...
	@Override
	public MouseVisitationNotifyEvent sinkEvent(final DisplayEventSource eventSource,
												final QEvent qEvent) {
