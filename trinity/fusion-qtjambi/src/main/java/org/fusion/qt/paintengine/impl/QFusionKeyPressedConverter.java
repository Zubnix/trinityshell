 ...
 * @since 1.0
 */
public final class QFusionKeyPressedConverter implements
	...
	@Inject
	protected QFusionKeyPressedConverter(	@Named("QKeyPress") final QEvent.Type qType,
	...
	public KeyNotifyEvent sinkEvent(final DisplayEventSource source,
		...
		final KeyboardInput input = new BaseKeyboardInput(	Momentum.STARTED,
															key,
															inputModifiers);
