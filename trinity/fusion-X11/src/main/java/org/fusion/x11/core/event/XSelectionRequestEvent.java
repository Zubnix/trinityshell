 ...
 * @since 1.0
 */
public class XSelectionRequestEvent extends BaseDisplayEvent {
	 ...
	 * @param property
	 */
	public XSelectionRequestEvent(final XWindow owner,
			final XWindow requestor, final XAtom selection, final XAtom target,
			final XAtom property) {
		super(XSelectionRequestEvent.TYPE, owner);
