...
public class XCoreAtoms {
	...
	// *********************//
	public XCoreAtoms(final XDisplay display) {
		...
		this.capHeight = atomRegistry.register(new XAtom(display, "CAP_HEIGHT",
				Long.valueOf(XProtocolConstants.CAP_HEIGHT)));
		this.cardinal = atomRegistry.register(new XAtom(display, "CARDINAL",
				Long.valueOf(XProtocolConstants.CARDINAL)));
		this.colormap = atomRegistry.register(new XAtom(display, "COLORMAP",
				Long.valueOf(XProtocolConstants.COLORMAP)));
		this.copyright = atomRegistry.register(new XAtom(display, "COPYRIGHT",
				Long.valueOf(XProtocolConstants.COPYRIGHT)));
		this.cursor = atomRegistry.register(new XAtom(display, "CURSOR", Long
				.valueOf(XProtocolConstants.CURSOR)));
		this.cutBuffer0 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER0", Long.valueOf(XProtocolConstants.CUT_BUFFER0)));
		this.cutBuffer1 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER1", Long.valueOf(XProtocolConstants.CUT_BUFFER1)));
		this.cutBuffer2 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER2", Long.valueOf(XProtocolConstants.CUT_BUFFER2)));
		this.cutBuffer3 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER3", Long.valueOf(XProtocolConstants.CUT_BUFFER3)));
		this.cutBuffer4 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER4", Long.valueOf(XProtocolConstants.CUT_BUFFER4)));
		this.cutBuffer5 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER5", Long.valueOf(XProtocolConstants.CUT_BUFFER5)));
		this.cutBuffer6 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER6", Long.valueOf(XProtocolConstants.CUT_BUFFER6)));
		this.cutBuffer7 = atomRegistry.register(new XAtom(display,
				"CUT_BUFFER7", Long.valueOf(XProtocolConstants.CUT_BUFFER7)));
		this.drawable = atomRegistry.register(new XAtom(display, "DRAWABLE",
				Long.valueOf(XProtocolConstants.DRAWABLE)));
		this.endSpace = atomRegistry.register(new XAtom(display, "END_SPACE",
				Long.valueOf(XProtocolConstants.END_SPACE)));
		this.familyName = atomRegistry.register(new XAtom(display,
				"FAMILY_NAME", Long.valueOf(XProtocolConstants.FAMILY_NAME)));
		this.font = atomRegistry.register(new XAtom(display, "FONT", Long
				.valueOf(XProtocolConstants.FONT)));
		this.fontName = atomRegistry.register(new XAtom(display, "FONT_NAME",
				Long.valueOf(XProtocolConstants.FONT_NAME)));
		this.fullName = atomRegistry.register(new XAtom(display, "FULL_NAME",
				Long.valueOf(XProtocolConstants.FULL_NAME)));
		this.integer = atomRegistry.register(new XAtom(display, "INTEGER", Long
				.valueOf(XProtocolConstants.INTEGER)));
		this.italicAngle = atomRegistry.register(new XAtom(display,
				"ITALIC_ANGLE", Long.valueOf(XProtocolConstants.ITALIC_ANGLE)));
		this.maxSpace = atomRegistry.register(new XAtom(display, "MAX_SPACE",
				Long.valueOf(XProtocolConstants.MAX_SPACE)));
		this.minSpace = new XAtom(display, "MIN_SPACE",
				Long.valueOf(XProtocolConstants.MIN_SPACE));
		this.normSpace = atomRegistry.register(new XAtom(display, "NORM_SPACE",
				Long.valueOf(XProtocolConstants.NORM_SPACE)));
		...
		this.pointSize = atomRegistry.register(new XAtom(display, "POINT_SIZE",
				Long.valueOf(XProtocolConstants.POINT_SIZE)));
		this.primary = atomRegistry.register(new XAtom(display, "PRIMARY", Long
				.valueOf(XProtocolConstants.PRIMARY)));
		this.quadWidth = atomRegistry.register(new XAtom(display, "QUAD_WIDTH",
				Long.valueOf(XProtocolConstants.QUAD_WIDTH)));
		this.rectangle = atomRegistry.register(new XAtom(display, "RECTANGLE",
				Long.valueOf(XProtocolConstants.RECTANGLE)));
		this.resolution = atomRegistry.register(new XAtom(display,
				"RESOLUTION", Long.valueOf(XProtocolConstants.RESOLUTION)));
		this.resouceManager = atomRegistry.register(new XAtom(display,
				"RESOURCE_MANAGER", Long
						.valueOf(XProtocolConstants.RESOURCE_MANAGER)));
		this.rgbBestMap = atomRegistry.register(new XAtom(display,
				"RGB_BEST_MAP", Long.valueOf(XProtocolConstants.RGB_BEST_MAP)));
		this.rgbBlueMap = atomRegistry.register(new XAtom(display,
				"RGB_BLUE_MAP", Long.valueOf(XProtocolConstants.RGB_BLUE_MAP)));
		this.rgbColorMap = atomRegistry
				.register(new XAtom(display, "RGB_COLOR_MAP", Long
						.valueOf(XProtocolConstants.RGB_COLOR_MAP)));
		this.rgbDefaultMap = atomRegistry.register(new XAtom(display,
				"RGB_DEFAULT_MAP", Long
						.valueOf(XProtocolConstants.RGB_DEFAULT_MAP)));
		this.rgbGrayMap = atomRegistry.register(new XAtom(display,
				"RGB_GRAY_MAP", Long.valueOf(XProtocolConstants.RGB_GRAY_MAP)));
		this.rgbGreenMap = atomRegistry
				.register(new XAtom(display, "RGB_GREEN_MAP", Long
						.valueOf(XProtocolConstants.RGB_GREEN_MAP)));
		this.rgbRedMap = atomRegistry.register(new XAtom(display,
				"RGB_RED_MAP", Long.valueOf(XProtocolConstants.RGB_RED_MAP)));
		this.secondary = atomRegistry.register(new XAtom(display, "SECONDARY",
				Long.valueOf(XProtocolConstants.SECONDARY)));
		this.strikeoutAscent = atomRegistry.register(new XAtom(display,
				"STRIKEOUT_ASCENT", Long
						.valueOf(XProtocolConstants.STRIKEOUT_ASCENT)));
		this.strikeoutDescent = atomRegistry.register(new XAtom(display,
				"STRIKEOUT_DESCENT", Long
		...
		this.subscriptX = atomRegistry.register(new XAtom(display,
				"SUBSCRIPT_X", Long.valueOf(XProtocolConstants.SUBSCRIPT_X)));
		this.subscriptY = atomRegistry.register(new XAtom(display,
				"SUBSCRIPT_Y", Long.valueOf(XProtocolConstants.SUBSCRIPT_Y)));
		...
		this.underlinePosition = atomRegistry.register(new XAtom(display,
				"UNDERLINE_POSITION", Long
						.valueOf(XProtocolConstants.UNDERLINE_POSITION)));
		this.underlineThickness = atomRegistry.register(new XAtom(display,
				"UNDERLINE_THICKNESS", Long
						.valueOf(XProtocolConstants.UNDERLINE_THICKNESS)));
		this.visualId = atomRegistry.register(new XAtom(display, "VISUALID",
				Long.valueOf(XProtocolConstants.VISUALID)));
		...
		this.xHeight = atomRegistry.register(new XAtom(display, "X_HEIGHT",
				Long.valueOf(XProtocolConstants.X_HEIGHT)));
