 ...
 * 
 */
public class XDummyDisplayPlatform extends XDisplayPlatform {
	public XDummyDisplayPlatform(final PainterFactoryProvider painterFactoryProvider,
	                             final XCoreInterfaceProvider xCoreInterfaceProvider)    {
		super(painterFactoryProvider,
